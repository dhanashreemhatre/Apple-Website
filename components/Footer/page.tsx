...
<p className='text-[12px] text-[#777] pt-4'>A subscription is required for Apple Arcade, Apple Fitness+, and Apple Music.</p>
      ...
      <div className='text-[12px] py-4 text-[#777777]'>
        <p>More ways to shop: <a href="" className='text-blue-500 underline'>Find an Apple Store</a> or <a href="" className='text-blue-500 underline'>other retailer</a> near you. Or call 1-800-MY-APPLE.</p>
      </div>
      <hr />
      <div className='text-[12px] py-4 text-[#777777]'>
        <div className='flex justify-between'>
            ...
            <div className={`${styles.copyright_links}`}>
             <a href="">Privacy </a> | <a href=""> Policy </a> | <a href=""> Terms of Use </a> | <a href=""> Sales and Refunds </a>|<a href=""> Legal </a>|<a href=""> Site Map </a>
            </div>
